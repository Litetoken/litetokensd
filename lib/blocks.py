...
Sieve blockchain for Litetokens transactions, and add them to the database.
"""
    ...
    while True:
        ...
        if block_index <= block_count:
            ...
            for tx_hash in litecoin.get_mempool():
                ...
                # If already in litetokensd mempool, copy to new one.
